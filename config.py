...
def reload_config():
    ...
    if 'COMPANY_MATCH_THRESHOLD' in os.environ:
        try:
            PARSING_CONFIG['company_match_threshold'] = int(os.environ['COMPANY_MATCH_THRESHOLD'])
        except Exception:
            pass
    if 'COMPANY_MATCH_ALGORITHM' in os.environ:
        PARSING_CONFIG['company_match_algorithm'] = os.environ['COMPANY_MATCH_ALGORITHM']
